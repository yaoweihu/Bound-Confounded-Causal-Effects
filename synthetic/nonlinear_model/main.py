...
data = utils.gen_nonlinear_data(data_size)
int_y = utils.ground_truth(int_x, test_num, is_linear=False)
effect = [round(int_y[1] - int_y[0], 3)]
################################### Model ##############################
generator = model.Generator(noise_size, hidden_size, x_size, w_size, y_size)
